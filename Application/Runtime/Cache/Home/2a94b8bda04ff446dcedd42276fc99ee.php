   ...
   <nav class="navbar-default navbar-static-side" role="navigation"> 
    ...
    <div class="sidebar-collapse"> 
     <ul class="nav" id="side-menu"> 
      ...
      <li><a href="#"><span class="nav-label">司机管理</span> <span class="fa arrow"></span> </a> 
       <ul class="nav nav-second-level"> 
        <li> <a class="J_menuItem" href="/index.php/Home/driver/lists">司机列表</a> </li> 
        <li> <a class="J_menuItem" href="/index.php/Home/driver/audit">司机审核</a> </li>
        <li> <a class="J_menuItem" href="/index.php/Home/driver/notaudit">审核未通过</a> </li>
        <li> <a class="J_menuItem" href="/index.php/Home/driver/bankcard">司机银行卡</a> </li>  
       </ul> 
      </li> 
      <li> <a href="#"><span class="nav-label">用户管理</span><span class="fa arrow"></span></a> 
       <ul class="nav nav-second-level"> 
        <li><a class="J_menuItem" href="/index.php/Home/user/lists">用户列表</a> </li> 
       </ul>
      </li> 
      <li> <a href="#"><span class="nav-label">订单管理</span><span class="fa arrow"></span></a> 
       <ul class="nav nav-second-level"> 
        <li><a class="J_menuItem" href="/index.php/Home/order/lists">订单列表</a> </li> 
       </ul>
      </li>
      <li> <a href="#"><span class="nav-label">系统管理</span><span class="fa arrow"></span></a> 
       <ul class="nav nav-second-level"> 
    <!--     <li><a class="J_menuItem" href="/index.php/Home/system/draw">提现记录</a></li> --> 
        <li><a class="J_menuItem" href="/index.php/Home/system/explain">租车说明</a></li>
        <li><a class="J_menuItem" href="/index.php/Home/system/about">关于说明</a></li> 
       </ul>
      </li>
     </ul> 
    </div> 
