      ...
      <div class="ibox-title"> 
       ...
       <div class="btn-group" style="float:right;">
          ...
          <ul class="dropdown-menu">
              <li><a href="/index.php/Admin/order/lists?status=1">已完成</a>
              </li>
              <li><a href="/index.php/Admin/order/lists?status=2">已付款</a>
              </li>
              <li><a href="/index.php/Admin/order/lists?status=3">未付款</a>
              </li>
              <li><a href="/index.php/Admin/order/lists?status=4">已取消</a>
              </li>
          </ul>
       </div>
      </div> 
       ...
       <div class="table-responsive"> 
        <table class="table table-striped"> 
         ...
         <?php if(is_array($order_list)): foreach($order_list as $key=>$item): ?><tr> 
           ...
           <td><?php echo ($item["user_id"]); ?>&<?php echo ($item["username"]); ?></td> 
           ...
           <td>
              <a href="/index.php/admin/order/detail?PID=<?php echo ($item["PID"]); ?>">查看</a>
    ...
    <script type="text/javascript">
     function del(id){
    	 if (confirm('确定删除吗？') == true){
    		 $.ajax({
    			 url: '<?php echo U('Admin/order/ajax_order_delete');?>',
    			 type: 'post',
    			 dataType: 'json',
    		     data: {'id':id},
