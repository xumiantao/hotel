     ...
     <div class="ibox float-e-margins"> 
      <div class="ibox-title"> 
       ...
       <div class="btn-group" style="float:right;margin-top:-10px;">
          <button data-toggle="dropdown" class="btn btn-warning dropdown-toggle" onclick="location='/index.php/admin/product/cateAdd'">添加分类+</button>
       </div>
      </div> 
      <div class="ibox-content">  
       <div class="table-responsive"> 
        <table class="table table-striped"> 
         ...
         <tbody> 
         <?php if(is_array($cate_list)): foreach($cate_list as $key=>$item): ?><tr> 
           <td><?php echo ($item["id"]); ?></td> 
           <td><?php echo ($item["catename"]); ?></td> 
           <td><img alt="<?php echo ($item["cataname"]); ?>" src="/Uploads/Public/cate/<?php echo ($item["cateimg"]); ?>" width="80" height="80"></td> 
           <td>
